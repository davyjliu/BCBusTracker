...
public class ArrivalsListFragment extends ListFragment {
    ...
    HttpArrivalDataProvider hadp = new HttpArrivalDataProvider(selected);
...
//
        try {
            data = hadp.dataSourceToString();
            ArrivalsParser.parseArrivals(selected, data);
